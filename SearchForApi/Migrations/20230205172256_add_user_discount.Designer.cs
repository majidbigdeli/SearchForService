...
namespace SearchForApi.Migrations
{
    ...
    [Migration("20230205172256_add_user_discount")]
    partial class add_user_discount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.Feature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.FeatureItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.Movie", b =>
                {
                    ...
                    b.HasIndex("AssetsCheckedByUserId");
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.PaymentGateway", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.Scene", b =>
                {
                    ...
                    b.Property<int?>("CheckExcludeType")
                        .HasColumnType("integer");

                    b.Property<int>("CheckResultType")
                        .HasColumnType("integer");

                    b.Property<int?>("CheckType")
                        .HasColumnType("integer");

                    b.Property<Guid?>("CheckedBySceneId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.ShareHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.UserDevice", b =>
                {
                    ...
                    b.Property<DateTime>("DataChangedOn")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.UserDiscount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.FeatureItem", b =>
                {
                    b.HasOne("SearchForApi.Models.Entities.User", "CheckedByUser")
                        .WithMany("ChangedFeatureItems")
                        .HasForeignKey("ChangedByUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SearchForApi.Models.Entities.Feature", "Feature")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.Movie", b =>
                {
                    b.HasOne("SearchForApi.Models.Entities.User", "AssetsCheckedByUser")
                        .WithMany("AssetsCheckedMovies")
                        .HasForeignKey("AssetsCheckedByUserId");
                    ...
                    b.Navigation("AssetsCheckedByUser");
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("SearchForApi.Models.Entities.PaymentGateway", "Gateway")
                        .WithMany("Payments")
                        .HasForeignKey("GatewayType");
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.PaymentGateway", b =>
                {
                    b.HasOne("SearchForApi.Models.Entities.User", "ModifiedByUser")
                        .WithMany("ModifiedPaymentGateways")
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.Scene", b =>
                {
                    b.HasOne("SearchForApi.Models.Entities.Scene", "CheckedByScene")
                        .WithMany("CheckedScenes")
                        .HasForeignKey("CheckedBySceneId");
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.ShareHistory", b =>
                {
                    b.HasOne("SearchForApi.Models.Entities.Share", "Share")
                        .WithMany("ShareHistories")
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.Share", b =>
                {
                    b.Navigation("ShareHistories");
                });

            modelBuilder.Entity("SearchForApi.Models.Entities.User", b =>
                {
                    b.Navigation("AssetsCheckedMovies");

                    b.Navigation("Bookmarks");

                    b.Navigation("ChangedFeatureItems");
                    ...
                    b.Navigation("ModifiedPaymentGateways");
