...
namespace SearchForApi.Migrations
{
    ...
    public partial class add_banned_keywords : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var mergedBannedKeywords = englishBannedKeyword.Union(persianBannedKeyword).ToList();

            foreach (var keyword in mergedBannedKeywords)
                migrationBuilder.InsertData("BannedKeywords", new[] { "Id", "Keyword" }, new object[] { Guid.NewGuid(), keyword });
        }
