...
namespace SearchForApi.Migrations
{
    ...
    [Migration("20220304021958_limit_scenes")]
    partial class limit_scenes
    {
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.Scene", b =>
                {
                    ...
                    b.Property<Guid?>("ExcludedBySceneId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SearchForApi.Models.Entities.Scene", b =>
                {
                    ...
                    b.HasOne("SearchForApi.Models.Entities.Scene", "ExcludedByScene")
                        .WithMany("ExcludedScenes")
                        .HasForeignKey("ExcludedBySceneId");
